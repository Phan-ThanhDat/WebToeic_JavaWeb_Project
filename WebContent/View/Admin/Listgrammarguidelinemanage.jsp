...
<title>Adding page for guideline grammar</title>
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<li>
								<a href="#">Manage guideline Grammar</a>
							</li>
							<li class="active">Adding the list to grammar part</li>
							...
							<div class="col-xs-12">
								<table id="simple-table" class="table table-bordered table-hover">
									<thead>
										<tr>
													<th class="center">       
														ID grammar guideline
													</th>
													<th class="center">
														Name Grammar guideline
													</th>
													...
													<th class="center">
														Delete Grammar guideline
													</th>
													<th class="center">
													Add content Grammar Guideline
													</th>
									...
									<tbody>
										...
										<c:forEach items="${listgrammarguidelinemanage}" var="list">
												<tr>
														...
														<td class="center">
															${list.grammarguidelinename }
														</td>
														<td class="center">
															${list.grammarguidelineimage }
														</td>
														<td class="center">
															<a class="red" href="#">
    ...
    <form action="Insertgrammarguidelinename" method="POST">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add lesson guideline grammar</h4>
        </div>
